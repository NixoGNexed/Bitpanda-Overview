sap.ui.require([
  ...
  var sViewName = "com.myorg.bitpandaOverview.view.MainView";
      ...
      assertions: {
          ...
          iShouldSeeTheTitle: function () {
            return this.waitFor({
              ...
              properties: {
                text: "Title of com.myorg.bitpandaOverview"
              },
              success: function() {
                Opa5.assert.ok(true, "The page shows the correct title");
              },
              errorMessage: "App does not show the expected title com.myorg.bitpandaOverview"
            });
        }
      }
